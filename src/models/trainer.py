...
class Trainer(object):
    ...
    def validate(self, valid_iter, step=0):
        ...
        with torch.no_grad():
            for batch in valid_iter:
                ...
                outputs, _ = self.model(src, tgt, segs, clss, mask_src, mask_tgt, mask_cls, frame, dep)
    ...
    def _gradient_accumulation(self, true_batchs, normalization, total_stats,
        ...
        for batch in true_batchs:
            ...
            outputs, scores = self.model(src, tgt, segs, clss, mask_src, mask_tgt, mask_cls, frame, dep)
